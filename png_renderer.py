...
def generate_label_image(part: str, qty: str, bin_code: str | None = None):
...
def save_label_image(part: str, qty: str, bin_code: str | None, out_path: Path):
    img = generate_label_image(part, qty, bin_code)
